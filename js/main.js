...
// for (let i = 0; i < tabBtns.length; i++) {
//   tabBtns[i].addEventListener("click", () => {
//     tabBtns[count].classList.remove("tab_btn-active");
//     tabBodys[count].classList.remove("tab_body-active");
...
for (let i = 0; i < tabBtns.length; i++) {
  tabBtns[i].addEventListener("click", (e) => {
    ...
    document.querySelector(".tab_btn-active").classList.remove("tab_btn-active");
    document.querySelector(".tab_body-active").classList.remove("tab_body-active");
